#!/usr/bin/python
#----------------------------------------------------------------------------------------------#
#chap2asleap.py v0.2.1 (2010-09-16)                                                              #
...
while mainLoop:
   ...
   if not re.search("[0-f]", txtChal) :
	  txtChal = ""
	  print "Sorry, you can't input that for the CHAP Challenge. Only 0-9 a-f."
   elif len(txtChal) != 32 :
	  txtChal = ""
	  print "Sorry, PPP CHAP Challenge has to be 32 bytes in length."
   else : 
      mainLoop = False
...
while mainLoop:
   ...
   if not re.search("[0-f]", txtResp) :
	  print "Sorry, you can't input that for the CHAP Response. Only 0-9 a-f."
	  txtResp = ""
   elif len(txtResp) != 98 :
	  print "Sorry, PPP CHAP Response has to be 32 bytes in length."
	  txtResp = ""
   else : 
      mainLoop = False
...
#----------------------------------------------------------------------------------------------#
if verbose == True: print "[i]       Username: " + txtUser
if verbose == True: print "[i] CHAP Challenge: " + txtChal
if verbose == True: print "[i]  CHAP Response: " + txtResp
...
if verbose == True: print "[i] Auth Challenge: " + txtChal
if verbose == True: print "[i] Peer Challenge: " + (txtResp)[0:32]
if verbose == True: print "[i]  Peer Response: " + response
if verbose == True: print "[i]      Challenge: " + challenge
