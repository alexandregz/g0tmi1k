#!/usr/bin/python
#----------------------------------------------------------------------------------------------#
#dictionaries.py v0.2 (#1 2010-09-28)                                                          #
...
def removeDup (mode):
    ...
    print info+" Total dictionaries:", totalFiles
...
def updateScript():
   ...
   url = "http://g0tmi1k.googlecode.com/svn/trunk/dictionaries/dictionaries.py"
   req = Request(url)
   try:
      f = urlopen(req)
      local_file = open("dictionaries.py", "w")
...
#---Main---------------------------------------------------------------------------------------#
print "\033[36m[*]\033[0m dictionaries v"+version
...
try:
    while 1==1:
        print """-----------------------------------------------------\nMain Menu:\n-----------------------------------------------------
    1.) Remove duplicates form a dictionary
